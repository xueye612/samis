<template>
  <div class="page-stack">
    <section class="module-hero">
      <div>
        <h2 class="module-hero__title">并发症追踪</h2>
        <p class="module-hero__desc">按患者汇总术后异常事件，支持快速回溯到病例详情。</p>
      </div>
      <div class="module-hero__chips">
        <a-tag color="orangered">风险 {{ rows.length }}</a-tag>
      </div>
    </section>
    <a-card class="section-card" :bordered="false" title="并发症追踪">
...
const rows = computed(() => buildRows('followUps'));
