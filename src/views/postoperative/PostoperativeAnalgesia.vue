<template>
  <div class="page-stack">
    <section class="module-hero">
      <div>
        <h2 class="module-hero__title">术后镇痛追踪</h2>
        <p class="module-hero__desc">按病例持续跟踪疼痛评分与镇痛干预效果。</p>
      </div>
      <div class="module-hero__chips">
        <a-tag color="arcoblue">记录 {{ rows.length }}</a-tag>
      </div>
    </section>
    <a-card class="section-card" :bordered="false" title="术后镇痛">
