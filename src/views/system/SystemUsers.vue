<template>
  <div class="page-stack">
    <section class="module-hero">
      <div>
        <h2 class="module-hero__title">系统用户管理</h2>
        <p class="module-hero__desc">维护账号、角色与职责映射，确保临床与质控权限边界清晰。</p>
      </div>
      <div class="module-hero__chips">
        <a-tag color="arcoblue">用户 {{ rows.length }}</a-tag>
      </div>
    </section>
    <a-card class="section-card" :bordered="false" title="用户管理">
...
const rows = computed(() => buildRows('systemUsers'));
