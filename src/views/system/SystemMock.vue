<template>
  <div class="page-stack">
    <section class="module-hero">
      <div>
        <h2 class="module-hero__title">模拟数据配置</h2>
        <p class="module-hero__desc">维护原型演示数据集与刷新策略，保障演示一致性。</p>
      </div>
      <div class="module-hero__chips">
        <a-tag color="arcoblue">条目 {{ rows.length }}</a-tag>
      </div>
    </section>
    <a-card class="section-card" :bordered="false" title="数据模拟配置">
...
const rows = computed(() => buildRows('mock'));
