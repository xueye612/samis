<template>
  <div class="page-stack">
    <section class="module-hero">
      <div>
        <h2 class="module-hero__title">角色权限管理</h2>
        <p class="module-hero__desc">统一规范临床、质控与管理角色权限模型。</p>
      </div>
      <div class="module-hero__chips">
        <a-tag color="arcoblue">角色 {{ rows.length }}</a-tag>
      </div>
    </section>
    <a-card class="section-card" :bordered="false" title="角色权限">
...
const rows = computed(() => buildRows('roles'));
