...
export const seedVitalSignDict: VitalSignDictItem[] = [
  ...
  { id: 'vital-5', code: 'V-SPO2', name: '血氧饱和度 SpO2', shortCode: 'SpO2', unit: '%', normalRange: '95-100', lowerLimit: 95, upperLimit: 100, defaultValue: 99, chartEnabled: true, chartColor: '#2563eb', chartSymbol: 'diamond', decimalPlaces: 0, sortOrder: 5, enabled: true },
