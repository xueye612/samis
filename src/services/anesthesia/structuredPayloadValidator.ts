...
const fields: Record<string,string[]> = {
  airway_record: [...common,'recordLocalId','action','deviceCode','deviceName','deviceSize','attemptNo','airwayGrade','result','difficultyReason','extubationCondition','operatorId','operatorName','occurredAt'],
  ventilation_segment: [...common,'recordLocalId','mode','tidalVolumeMl','ratePerMin','peepCmh2o','fio2Percent','peakPressureCmh2o','etco2Mmhg','effectiveAt','endedAt','operatorId'],
  infusion_segment: [...common,'recordLocalId','drugCode','drugName','concentrationValue','concentrationUnit','rateValue','rateUnit','action','occurredAt','operatorId'],
  transfusion_verification: [...common,'recordLocalId','bloodBagNo','productCode','productName','aboType','rhType','volume','volumeUnit','verifierOneId','verifierTwoId','startedAt','endedAt','reactionCode','reactionDescription','treatment','occurredAt'],
  rescue_event: [...common,'recordLocalId','level','status','triggerCode','triggerDescription','triggeredAt','outcome','closedAt','closedBy'],
